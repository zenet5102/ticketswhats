...
const config = {
  ...
  runTicketCycleOnStartup: parseBoolean(process.env.TICKET_RUN_ON_STARTUP, false),
  phantomBajaSyncOnStartup: parseBoolean(process.env.PHANTOM_BAJA_SYNC_ON_STARTUP, false),
  secondQueueRunOnStartup: parseBoolean(process.env.SECOND_QUEUE_RUN_ON_STARTUP, false),
